						...
						<div class="order-summary clearfix">
							...
							<table class="shopping-cart-table table">
								...
								<tbody>
									...
									for(Livre l : livres){
									      out.println("<tr><td class='thumb'></td><td class='details'><a href='#'>"+l.getNom()+"</a><ul><li><span>de: "+l.getAuteur()+"</span></li><li></ul></td><td class='price text-center'><a href='' class='btn btn-success '> Modifier <i class='fa fa-arrow-circle-plus'></i></a></td><td class='text-right'><a href='' class='btn btn-danger'> Supprimer </a></td></tr>");}%>
								</tbody>
