...
<body>
<% ArrayList<DVD> dvd = lesDVD.findAllDVD();%>
	<!-- HEADER -->
	<header>
	...
	<div class="section">
		...
		<div class="container">
			...
			<div class="row">
				...
				<!-- Product Single -->
				<%for (DVD d : dvd){ 
				out.println("<div class='col-md-3 col-sm-6 col-xs-6'> <div class='product product-single'> <div class='product-body'> <h3 class='product-price'>"+d.getPrix()+" Euros</h3><h3 class='product-name'>"+d.getNom()+"</h3><h5 class='product-auteur'>de "+d.getRealisateur()+"</h5><h5 class='product-quantite'>Quantite :"+d.getQuantite()+"</h5><div class='product-btns'> <button class='primary-btn add-to-cart'><i class='fa fa-shopping-cart'></i> Ajouter au panier</button></div></div></div></div>");
				}%>
				<!-- /Product Single -->
			</div>
			<!-- /row -->
