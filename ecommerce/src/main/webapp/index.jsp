				...
				<div id="home-slick">
					...
					<div class="banner banner-1">
						...
						<div class="banner-caption text-center">
							<h1>Livres</h1>
							<h1 class="white-color font-weak">Consulter nos livres </h1>
							<button class="primary-btn  btn-lg">Acheter Maintenant</button>
						</div>
					</div>
					<!-- /banner -->
					...
					<div class="banner banner-1">
						...
						<div class="banner-caption">
							<h1 class="primary-color"> CD<br><span class="white-color font-weak">La Musique que vous aimez</span></h1>
							<button class="primary-btn btn-lg">Acheter Maintenant</button>
						</div>
					</div>
					<!-- /banner -->
					...
					<div class="banner banner-1">
						...
						<div class="banner-caption">
							<h1 class="white-color"><span>Collection DVD</span></h1>
							<button class="primary-btn btn-lg">Acheter Maintenant</button>
						</div>
					</div>
					<!-- /banner -->
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6">
					<a class="banner banner-1" href="#">
						...
						<div class="banner-caption text-center">
							<h2 class="white-color">LIVRES</h2>
						</div>
					</a>
				</div>
				<!-- /banner -->
